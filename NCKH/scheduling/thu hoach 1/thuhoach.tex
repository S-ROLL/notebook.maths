...
Tuỳ thuộc theo dạng bài toán yêu cầu mà ta sẽ có phương tiếp cận và xử lý khác nhau, các dạng bài toán được giới thiệu được chia theo bảng bên dưới
\begin{figure}[h!]
	\centering
	...
	$\alpha$ & $prec$ & $1|prec|\sum C_j$ & $\times$&$\times$ & $1|prec|\sum w_j C_j$ \\
